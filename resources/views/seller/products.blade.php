...
.product-card{background:var(--card-bg);border-radius:18px;overflow:hidden;border:1px solid var(--card-border);box-shadow:var(--shadow);transition:0.2s;backdrop-filter:blur(20px)}
.product-card:hover{transform:translateY(-2px);box-shadow:0 18px 36px rgba(0,0,0,0.28)}
.product-card img{width:100%;height:150px;object-fit:cover}
.card-body{padding:14px}
.product-name{font-size:14px;font-weight:700;margin-bottom:4px;color:var(--text)}
.product-cat{font-size:11px;color:var(--indigo-light);font-weight:600;margin-bottom:6px}
.product-price{font-size:15px;font-weight:700;margin-bottom:8px;color:var(--text)}
...
.btn-sm{padding:6px 12px;border-radius:10px;font-size:12px;font-weight:600;border:1px solid var(--card-border);background:rgba(255,255,255,0.05);color:var(--text);cursor:pointer;font-family:inherit;text-decoration:none;display:inline-flex;align-items:center}
.btn-sm:hover{border-color:var(--indigo);color:var(--indigo-light)}
...
.modal{background:rgba(13,13,31,0.96);border-radius:24px;padding:32px;max-width:600px;width:100%;max-height:90vh;overflow-y:auto;box-shadow:var(--shadow);border:1px solid var(--card-border);backdrop-filter:blur(20px)}
.modal-title{font-size:18px;font-weight:700;margin-bottom:24px;letter-spacing:-0.3px;color:var(--text)}
.form-grid{display:grid;grid-template-columns:1fr 1fr;gap:14px}
.field{display:flex;flex-direction:column;gap:6px}
.field label{font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:0.04em;color:var(--muted)}
.frost-input,.frost-select,.frost-textarea{padding:10px 14px;border-radius:12px;border:1px solid var(--card-border);background:rgba(255,255,255,0.05);font-size:13px;font-family:inherit;color:var(--text);width:100%}
...
.empty-state{text-align:center;padding:80px;color:var(--muted);grid-column:1/-1}
</style>
@endpush
