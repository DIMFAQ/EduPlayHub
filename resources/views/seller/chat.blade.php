...
@push('styles')
<style>
.chat-list{background:var(--card-bg);border-radius:20px;border:1px solid var(--card-border);box-shadow:var(--shadow);overflow:hidden;backdrop-filter:blur(20px)}
...
.chat-name{font-weight:700;font-size:15px;margin-bottom:3px;color:var(--text)}
